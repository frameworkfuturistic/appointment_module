...
//           <h1 className="text-4xl text-sky-700 font-serif text-wrap">Orthopaedics</h1>
...
//           {/* CARD-1 */}
//           <Card className="  h-96  max-w-60 grid grid-flow-row justify-center  hover:border-b-4  hover:border-t-sky-600 hover:border-b-sky-600 border-4  ">
