...
export function PatientReview() {
  ...
  return (
    ...
    <div className="sm:min-h-[700px] grid justify-center">
      ...
      <div className="bg-slate-50 bg-pattern4-bg h-[200px] w-[90%] sm:w-[1000px]  -mt-[100px] place-self-center grid grid-cols-2 md:grid-cols-4 gap-4 justify-items-center">
      ...
      <div className="bg-dottedmap bg-cover bg-slate-200">
        <div className="flex flex-col items-center text-center py-8 gap-2">
          ...
          <img src="/activity.png" alt="icon" className="h-8 w-8 md:h-10 md:w-10" />
          <Carousel className="h-52 w-[90%] sm:w-[700px]">
            <CarouselContent
              style={{
