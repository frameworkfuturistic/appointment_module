      ...
      <div className="mb-12">
        ...
        <div>
          <div className="grid grid-cols-3 gap-x-20 gap-y-16  ">
            <Card className="  transition ease-in-out delay-150 bg-slate-100  hover:-translate-y-1 hover:scale-110 hover:bg-white duration-300 ...  shadow-none border-none md:max-w-72 md:max-h-48 text-wrap  flex flex-col items-center hover:shadow-lg hover:shadow-sky-500  ">
              <HeartPulse
                color="#0284c7"
                strokeWidth={1.25}
