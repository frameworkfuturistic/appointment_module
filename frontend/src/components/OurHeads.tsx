  ...
  return (
    ...
    <div className="bg-pattern4-bg bg-slate-50 py-8 w-full" id="gallery-page">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 px-4 py-8">
        {/* CARD-1 */}
        <Card className="lg:min-h-64 lg:max-w-60 grid grid-flow-row justify-center  hover:border-b-4  hover:border-t-rose-500 hover:border-b-rose-500 border-4   duration-700 ease-in-out hover:scale-110">
          <img
